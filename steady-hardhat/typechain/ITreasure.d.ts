...
interface ITreasureInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "generateTreasureChest",
...
export class ITreasure extends BaseContract {
